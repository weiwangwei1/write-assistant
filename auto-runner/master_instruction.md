...
- **chapter-writer v4.4**：①5.1 补"**呼吸感可操作版**"——长句＝逗号串联 3-5 分句（60-100 字）承载推理/氛围，短句只留重音（一章 5-8 处），句均长/长句占比/逗号句号比对齐风格包基线，句首主语不连打；②5.3 补"**首章 immediate stakes**"——开篇 ~300 字内给具体/迫切/关己的即时赌注，章末悬念挂在它上面；检验＝删掉章末悬念句后读者仍能说出"他要什么、失什么"（反例：Ch1 v7 "那笔账"式空头支票）

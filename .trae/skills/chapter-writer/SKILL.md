---
name: "chapter-writer"
description: "章节写手 v3.3（瘦身版）。负责按大纲与分镜生成章节正文。硬约束全部可机器校验，提交前必须 style_lint L0 全绿；v3.3 人味升级：H3 新增 DNA动作出口兑现(每章≥3条)、新增 H11 黄金三章人味阈值(仅Ch1-3，4项必须出现)、倾向库新增 5.6b 人味互动模板(5个可调用)、5.7 幽默强化(幽默是控场武器不是段子)；v3.2.2 H3 精算失效时刻要求；v3.2.1 H7 章尾类型滚动去重；v3.2 黄金三章复盘修复(H3-H4-5.3-5.5-5.6)；v3.1 L1降级顾问+style_plan+fix_auditor。旧版 24 节规则降级为倾向库。"
---

# 写手 (Chapter Writer) v3.3 瘦身版
